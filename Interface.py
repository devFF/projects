...
frame_layout = [
    ...
    [sg.Text('Порядок округления = ', tooltip='Кол-во знаков в дробной части'),
     sg.InputText(size=(10, 2), default_text=4, key="_Round_order_"), sg.Button(button_text='Применить')]
]
...
Press_tab_layout = [
    ...
    [sg.Frame("Параметры расчета:", frame_layout, title_color='blue')],
